...
#   python3 -m manim example_transform_01.py Example_Transform_01_01 --resolution 360,640 -pl
# Full resolution rendering
#   python3 -m manim example_transform_01.py Example_Transform_01_01 --resolution 720,1280 -p --high_quality
#

# Gif animation
#   python3 -m manim example_transform_01.py Example_Transform_01_01 --resolution 360,640 -mi
